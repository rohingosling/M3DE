@echo off
rem **************************************************************************
rem  Build Script: M3DE Test (GFX-13 v2)
rem  Compiler:     Borland Turbo C++ 3.1
rem  Environment:  DOS / DOSBox
rem
rem  Description:
rem
rem    Compiles GFX-13 v2 (C with inline assembly), M3DE (C++), and the test
...
bcc -c -ml -2 -I..\GFX13\v2 ..\GFX13\v2\gfx13.c >> build.log
if errorlevel 1 goto fail

echo Compiling M3DE.CPP ...
echo ---- M3DE.CPP ---- >> build.log
bcc -c -ml -I..\GFX13\v2 -I..\M3DE ..\M3DE\m3de.cpp >> build.log
if errorlevel 1 goto fail

echo Compiling TEST.CPP ...
echo ---- TEST.CPP ---- >> build.log
bcc -c -ml -I..\GFX13\v2 -I..\M3DE test.cpp >> build.log
if errorlevel 1 goto fail
