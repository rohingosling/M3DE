...
A 3D graphics engine for writing mode-13h demos for DOS, written in C++ back in the 90s. Built on top of the [GFX-13](https://github.com/rohingosling/gfx-13) VGA Mode 13h 2D graphics library (v2, C with inline assembly).
...
||||
|:---:|:---:|:---:|
|![](images/capture/test-640x400.gif)|![](images/capture/demo1_000_640x400.gif)|![](images/capture/blocks03_000_640x400.gif)|
